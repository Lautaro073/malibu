...
export function StoreHeader() {
  ...
  const baseId = useId();
  const desktopSearchInputId = `${baseId}-desktop-input`;
  const mobileSearchInputId = `${baseId}-mobile-input`;
  const desktopSearchResultsId = `${baseId}-desktop-results`;
  const mobileSearchResultsId = `${baseId}-mobile-results`;
