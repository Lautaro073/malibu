...
export function StoreHeader({ initialPromoBanner = null }: StoreHeaderProps) {
  ...
  const desktopSearchInputId = "storefront-desktop-search-input";
  const mobileSearchInputId = "storefront-mobile-search-input";
  const desktopSearchResultsId = "storefront-desktop-search-results";
  const mobileSearchResultsId = "storefront-mobile-search-results";
          ...
          <div className="flex items-center justify-between gap-3 md:gap-5">
            <Link href="/" className="inline-flex items-center text-black">
              <Image
                ...
                fetchPriority="high"
              />
              <span className="sr-only">Malibú</span>
            </Link>
